...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DevicePlayFullScreenMovie : FsmStateAction
	{
		...
		// NOTICE: Comment this for fixing Jenkins build error - CF
...
//			Handheld.PlayFullScreenMovie(moviePath.Value, fadeColor.Value, movieControlMode, movieScalingMode);
			Handheld.PlayFullScreenMovie(moviePath.Value, fadeColor.Value, FullScreenMovieControlMode.Full, FullScreenMovieScalingMode.AspectFit);
		}
